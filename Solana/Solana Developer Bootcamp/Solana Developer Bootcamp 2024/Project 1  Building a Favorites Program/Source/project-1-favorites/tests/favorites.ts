...
describe('Favorites', () => {
  ...
  it('Writes our favorites to the blockchain', async () => {
    ...
    // is an Anchor client method in TypeScript that reads and deserializes the on-chain account data (at favoritesPda) into a usable JavaScript object based on the Favorites struct in your smart contract.
